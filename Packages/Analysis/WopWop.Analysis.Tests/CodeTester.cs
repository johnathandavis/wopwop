...
public abstract class CodeTester<TGenerator> where TGenerator : ISourceGenerator, new()
{        private readonly ITestOutputHelper _outputHelper;

    public CodeTester(ITestOutputHelper outputHelper)
    {
    ...
    protected static Compilation CreateCompilation(string source, params MetadataReference[] metadataReferences)
        => CSharpCompilation.Create("compilation",
            ...
            metadataReferences.Concat(new[]
            {
                ...
                MetadataReference.CreateFromFile(typeof(RemoteTask<>).Assembly.Location),
                MetadataReference.CreateFromFile(typeof(MachineAnnotator).Assembly.Location),
                MetadataReference.CreateFromFile(typeof(MachineStructure).Assembly.Location),
            }),
